...
exports.default = {
    ...
    createBarterOffer: function createBarterOffer(req, res, next) {
        ...
        return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
            var validationErrors, newBarterOfferId, createdBarterOffer, barterOffer, barter, barterOfferNotification, io, nsp;
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        ...
                        case 16:
                            ...
                            _context5.next = 21;
                            return _barter2.default.findById(req.params.barterId);
                        ...
                        case 21:
                            ...
                            _context5.next = 25;
                            return BarterOfferNotification.create(barterOfferNotification);

                        case 25:
                            barterOfferNotification = _context5.sent;
                            _context5.next = 28;
                            return BarterOfferNotification.findById(barterOfferNotification.id).populate("offerUser relatedBarter");
