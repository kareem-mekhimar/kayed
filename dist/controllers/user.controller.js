...
exports.default = {
    ...
    updateUser: function updateUser(req, res, next) {
        ...
        return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        ...
                        case 12:
                            ...
                            return _context4.abrupt("return", next(new _ApiError2.default.NotFound('User')));
            ...
            }, _callee4, _this3, [[7, 19]]);
        }))();
    },
    checkIfUserExist: function checkIfUserExist(id, next) {
        var _this4 = this;
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            ...
                            _context6.prev = 5;
                            _context6.next = 8;
                            return Barter.find({ _id: req.user.id }).populate('relatedCategory relatedUser').sort({ creationDate: -1 }).limit(limit).skip((page - 1) * limit);
                        ...
                        case 11:
                            ...
                            response = new ApiResponse(userBarters, page, pageCount, limit, userBartersCount);
