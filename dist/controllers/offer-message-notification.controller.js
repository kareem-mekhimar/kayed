                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 10:
                            ...
                            _context.next = 13;
                            return _offerMessageNotification2.default.count({ user: req.user.id });
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 4:
                            _context3.next = 6;
                            return _offerMessageNotification2.default.update({ user: req.user.id, seen: false }, { seen: true }, { multi: true });
