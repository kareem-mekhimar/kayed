...
exports.default = {
    ...
    handleBarterImgs: function handleBarterImgs(imgs) {
        var imgsUrls = void 0;
        for (var i = 0; i < imgs.length; i++) {
            imgsUrls.push((0, _utils.writeBase64AndReturnUrl)(imgs[i], "barters/" + _mongoose2.default.Types.ObjectId() + i, req));
        }
        return imgsUrls;
    },
                        ...
                        case 10:
                            ...
                            if (imgs) {
                                for (i = 0; i < imgs.length; i++) {
                                    createdBarter.imgs.push((0, _utils.writeBase64AndReturnUrl)(imgs[i], "barters/" + createdBarter.id + i, req));
                                }
                            }
                            _context4.next = 14;
                            return createdBarter.save();
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        ...
                        case 4:
                            ...
                            return _context5.abrupt("return", next(new _ApiError2.default.NotFound('Barter')));
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 14:
                            ...
                            if (imgs) {
                                for (i = 0; i < imgs.length; i++) {
                                    updatedBarter.imgs.push((0, _utils.writeBase64AndReturnUrl)(imgs[i], "barters/" + updatedBarter.id + i, req));
                                }
                            }
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        ...
                        case 4:
                            ...
                            return _context7.abrupt("return", next(new _ApiError2.default.NotFound('Barter')));
