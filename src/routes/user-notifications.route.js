...
import BarterOfferNotificationController from "../controllers/barter-offer-notification.controller";
import OfferMessageNotificationController from "../controllers/offer-message-notification.controller";
...
router.route('/:id/notifications/auctions')
    .get(AuctionNotificationController.findAll)

router.route('/:id/notifications/auctions/unseen')
    .get(AuctionNotificationController.findUnseen)

router.route('/:id/notifications/auctions/reset')
    .put(AuctionNotificationController.reset)
...
router.route('/:id/notifications/barters-offers')
    .get(BarterOfferNotificationController.findAll)

router.route('/:id/notifications/barters-offers/unseen')
    .get(BarterOfferNotificationController.findManyUnseen)

router.route('/:id/notifications/barters-offers/reset')
    .put(BarterOfferNotificationController.resetAll)
// --------------------------------------------------------------
...
router.route('/:id/notifications/offer-messages')
    .get(OfferMessageNotificationController.findAll)

router.route('/:id/notifications/offer-messages/unseen')
    .get(OfferMessageNotificationController.findManyUnseen)

router.route('/:id/notifications/offer-messages/reset')
    .put(OfferMessageNotificationController.resetAll)
